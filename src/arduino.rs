...
#[repr(C)]
pub struct LiquidCrystal_I2C__bindgen_vtable(::core::ffi::c_void);
#[repr(C, packed)]
pub struct LiquidCrystal_I2C {
    pub vtable_: *const LiquidCrystal_I2C__bindgen_vtable,
    pub _Addr: u8,
...
extern "C" {
    ...
    pub fn LiquidCrystal_I2C_begin(this: *mut LiquidCrystal_I2C, cols: u8, rows: u8, charsize: u8);
}
extern "C" {
...
extern "C" {
    ...
    pub fn LiquidCrystal_I2C_createChar(this: *mut LiquidCrystal_I2C, arg1: u8, arg2: *mut u8);
}
extern "C" {
...
extern "C" {
    #[doc = "compatibility API function aliases"]
...
extern "C" {
    #[doc = "Unsupported API functions (not implemented in this library)"]
...
extern "C" {
    ...
    pub fn LiquidCrystal_I2C_init_bargraph(this: *mut LiquidCrystal_I2C, graphtype: u8) -> u8;
}
extern "C" {
...
impl LiquidCrystal_I2C {
    ...
    #[inline]
    pub unsafe fn setDelay(&mut self, arg1: ::core::ffi::c_int, arg2: ::core::ffi::c_int) {
    ...
    #[inline]
    pub unsafe fn draw_vertical_graph(&mut self, row: u8, column: u8, len: u8, pixel_col_end: u8) {
